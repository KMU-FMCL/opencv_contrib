...
public:
  size_t dataSize;
  inline T *getCpuData() { return data_cpu; }

  inline const T *getCpuData() const { return data_cpu; }
  ...
  inline const T *getGpuData() const { return data_cuda; }

  inline T *getGpuData() { return data_cuda; }
  void updateDeviceFromHost() {
    cudaSafeCall(cudaMemcpy(data_cuda, data_cpu, dataSize * sizeof(T),
                            cudaMemcpyHostToDevice));
  }
  void updateHostFromDevice() {
    cudaSafeCall(cudaMemcpy(data_cpu, data_cuda, dataSize * sizeof(T),
